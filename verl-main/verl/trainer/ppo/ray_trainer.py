...
class RayPPOTrainer:
    ...
    def _save_checkpoint(self):
        ...
        remove_previous_ckpt_in_save = self.config.trainer.get("remove_previous_ckpt_in_save", True)
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                metrics.update(
                    {
                        "reward/reward_mean": reward_tensor.sum(-1).mean(),
                        "reward/reward_std": reward_tensor.sum(-1).std(),
                    }
                )
                # training metrics
                metrics.update(
